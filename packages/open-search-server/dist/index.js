...
const launch = async ({ path, host, port, version, debug, onExit: onDied, onOutput }) => {
...
const generateId = () => randomBytes(15).toString("base64url");
var Index = class {
	name;
	uuid = randomBytes(11).toString("base64url");
	createdAt = Date.now();
...
//#endregion
export { MemoryOpenSearchServer, OpenSearchError, OpenSearchServer, RealOpenSearchServer, VERSION_3_5_0_MIN, download, launch };
