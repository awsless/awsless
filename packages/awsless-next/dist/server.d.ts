...
declare const LATEST_BUNDLE_ALIAS = "latest";
...
declare const withBundleRoute: <T>(routeKey: string, internalInvoke: InternalInvoke, callback: () => T) => T;
