...
/** The table name of the queries that are available. */
export const SCHEMA_TABLE = process.env.SCHEMA_TABLE

/** The table name of the request locks. */
export const LOCK_TABLE = process.env.LOCK_TABLE
