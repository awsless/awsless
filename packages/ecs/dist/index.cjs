...
function encode(decoded) {
  ...
  for (let i3 = 0; i3 < decoded.length; i3++) {
    ...
    if (i3 > 0) writer.write(semicolon);
...
function getRelativePath(from, to) {
  ...
  if (fromParts.length) {
    let i3 = fromParts.length;
    while (i3--) fromParts[i3] = "..";
  }
...
function getLocator(source) {
  ...
  const lineOffsets = [];
  for (let i3 = 0, pos = 0; i3 < originalLines.length; i3++) {
    lineOffsets.push(pos);
    pos += originalLines[i3].length + 1;
  }
  ...
  "../../node_modules/.pnpm/magic-string@0.30.21/node_modules/magic-string/dist/magic-string.es.mjs"() {
    ...
    Mappings = class {
      ...
      advance(str) {
        ...
        if (lines.length > 1) {
          for (let i3 = 0; i3 < lines.length - 1; i3++) {
      ...
      indent(indentStr, options) {
        ...
        if (options.exclude) {
          ...
          exclusions.forEach((exclusion) => {
            for (let i3 = exclusion[0]; i3 < exclusion[1]; i3 += 1) {
              isExcluded[i3] = true;
            }
          });
        }
      ...
      _replaceRegexp(searchValue, replacement) {
        function getReplacement(match, str) {
          if (typeof replacement === "string") {
            return replacement.replace(/\$(\$|&|\d+)/g, (_2, i3) => {
              if (i3 === "$") return "$";
              if (i3 === "&") return match[0];
              const num = +i3;
              if (num < match.length) return match[+i3];
              return `$${i3}`;
            });
          } else {
    ...
    Bundle = class _Bundle {
      ...
      generateDecodedMap(options = {}) {
        ...
        this.sources.forEach((source, i3) => {
          if (i3 > 0) {
      ...
      indent(indentStr) {
        ...
        this.sources.forEach((source, i3) => {
          ...
          const indentStart = trailingNewline || i3 > 0 && /\r?\n$/.test(separator);
      ...
      toString() {
        const body = this.sources.map((source, i3) => {
          const separator = source.separator !== void 0 ? source.separator : this.separator;
          const str = (i3 > 0 ? separator : "") + source.content.toString();
          return str;
        }).join("");
...
var require_branding = __commonJS({
  "../../node_modules/.pnpm/expect-type@1.3.0/node_modules/expect-type/dist/branding.js"(exports2) {
    "use strict";
...
var require_messages = __commonJS({
  "../../node_modules/.pnpm/expect-type@1.3.0/node_modules/expect-type/dist/messages.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
  }
});
...
var require_overloads = __commonJS({
  "../../node_modules/.pnpm/expect-type@1.3.0/node_modules/expect-type/dist/overloads.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
  }
});
...
var require_utils = __commonJS({
  "../../node_modules/.pnpm/expect-type@1.3.0/node_modules/expect-type/dist/utils.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
  }
});
...
var require_dist = __commonJS({
  "../../node_modules/.pnpm/expect-type@1.3.0/node_modules/expect-type/dist/index.js"(exports2) {
    "use strict";
...
var import_utils4 = require("@awsless/utils");
...
function C({ force: e3 } = {}) {
  let r2 = e3 || B(), a2 = (t, o2, u2, n3) => {
    let g2 = "", s2 = 0;
    do
      g2 += t.substring(s2, n3) + u2, s2 = n3 + o2.length, n3 = t.indexOf(o2, s2);
    while (~n3);
    ...
    return n3.open = t, n3.close = o2, n3;
  }, c2 = {
    isColorSupported: r2
  }, f2 = (t) => `\x1B[${t}m`;
  for (let t in b) {
...
function requireReactIs_production_min() {
  ...
  reactIs_production_min.SuspenseList = n3;
  ...
  reactIs_production_min.isValidElementType = function(a2) {
    return "string" === typeof a2 || "function" === typeof a2 || a2 === d3 || a2 === f2 || a2 === e3 || a2 === m2 || a2 === n3 || a2 === t || "object" === typeof a2 && null !== a2 && (a2.$$typeof === q || a2.$$typeof === p2 || a2.$$typeof === g2 || a2.$$typeof === h2 || a2.$$typeof === l2 || a2.$$typeof === u2 || void 0 !== a2.getModuleId) ? true : false;
  };
  ...
  while (i3 !== iLength) {
    ...
    if (iStart !== i3) {
      if (iStart === 0) {
        ...
        const n3 = i3 - iStart;
        if (n3 > nContextLines) {
          jLength -= n3 - nContextLines;
          hasExcessAtStartOrEnd = true;
        }
      } else {
        const n3 = i3 - iStart;
        if (n3 > nContextLines2) {
          jLength -= n3 - nContextLines2;
...
function resolveDeps(usedFixtures, registrations, depSet = /* @__PURE__ */ new Set(), pendingFixtures = []) {
  usedFixtures.forEach((fixture) => {
    ...
    depSet.add(fixture);
    resolveDeps([...fixture.deps].map((n3) => n3 === fixture.name ? fixture.parent : registrations.get(n3)).filter((n3) => !!n3), registrations, depSet, pendingFixtures);
    pendingFixtures.push(fixture);
    depSet.clear();
  });
...
function assertAbove(n3, msg) {
  if (msg) flag2(this, "message", msg);
  let obj = flag2(this, "object"), doLength = flag2(this, "doLength"), flagMsg = flag2(this, "message"), msgPrefix = flagMsg ? flagMsg + ": " : "", ssfi = flag2(this, "ssfi"), objType = type(obj).toLowerCase(), nType = type(n3).toLowerCase();
  ...
  } else if (!isNumeric(n3) && (doLength || isNumeric(obj))) {
    throw new AssertionError(
...
function assertLeast(n3, msg) {
  if (msg) flag2(this, "message", msg);
  let obj = flag2(this, "object"), doLength = flag2(this, "doLength"), flagMsg = flag2(this, "message"), msgPrefix = flagMsg ? flagMsg + ": " : "", ssfi = flag2(this, "ssfi"), objType = type(obj).toLowerCase(), nType = type(n3).toLowerCase(), errorMessage, shouldThrow = true;
  if (doLength && objType !== "map" && objType !== "set") {
    new Assertion(obj, flagMsg, ssfi, true).to.have.property("length");
  }
  if (!doLength && objType === "date" && nType !== "date") {
...
var JestChaiExpect = (chai, utils) => {
  ...
  function def(name, fn2) {
    const addMethod2 = (n3) => {
      const softWrapper = wrapAssertion(utils, n3, fn2);
      utils.addMethod(chai.Assertion.prototype, n3, softWrapper);
      utils.addMethod(globalThis[JEST_MATCHERS_OBJECT].matchers, n3, softWrapper);
    };
    if (Array.isArray(name)) {
      name.forEach((n3) => addMethod2(n3));
    } else {
      addMethod2(name);
    }
  }
...
for (let i3 = 0; i3 < chars3.length; i3++) {
  let c2 = chars3.charCodeAt(i3);
  intToChar3[i3] = c2, charToInt3[c2] = i3;
}
...
var o = class e2 extends Error {
  constructor(t, n3, r2, i3) {
    super(t), this.name = n3, this.code = n3, this.statusCode = r2, this.retryable = i3, this.$metadata = { httpStatusCode: r2 }, Object.setPrototypeOf(this, e2.prototype);
  }
};
...
var b2 = (e3, t) => {
  let n3 = Error(e3);
  return n3.cause = t, n3;
};
var x = (e3) => {
  if (!e3 || typeof e3 != "string") throw TypeError("filePath must be a non-empty string");
  let t = import_node_path.default.resolve(e3);
  try {
    let n3 = (0, import_node_fs.readFileSync)(t, "utf8");
...
var S = (e3, t = {}) => {
  let { pageSize: n3 = 10, tokenKey: r2 = "NextToken", itemsKey: i3 = "Items" } = t;
  if (!Number.isInteger(n3) || n3 <= 0) throw TypeError("pageSize must be a positive integer");
  if (e3.length === 0) return [{ [i3]: [] }];
  let a2 = [];
  for (let t2 = 0; t2 < e3.length; t2 += n3) {
    let o2 = e3.slice(t2, t2 + n3), s2 = t2 + n3 < e3.length, c2 = { [i3]: o2 };
    if (s2) {
      let e4 = c2;
      e4[r2] = o2.at(-1);
    }
...
var w = (e3) => {
  let t = typeof e3 == "string" ? Buffer.from(e3, "utf8") : Buffer.from(e3), n3 = false;
  return new import_node_stream.Readable({ read() {
    n3 ||= (this.push(t), this.push(null), true);
  } });
};
var T = (e3) => {
  let t;
...
function A(e3, t) {
  return Object.keys(t).every((n3) => {
    let r2 = t[n3], i3 = e3[n3];
    return Array.isArray(r2) ? !Array.isArray(i3) || r2.length > i3.length ? false : r2.every((e4, t2) => {
      let n4 = i3[t2];
      return e4 && typeof e4 == "object" && typeof n4 == "object" && n4 ? A(n4, e4) : n4 === e4;
...
function j(e3, t) {
  ...
  if (Array.isArray(e3) && Array.isArray(t)) return e3.length === t.length ? e3.every((e4, n4) => {
    let r3 = t[n4];
    return typeof e4 == "object" && e4 && typeof r3 == "object" && r3 ? j(e4, r3) : e4 === r3;
  }) : false;
  if (Array.isArray(e3) !== Array.isArray(t)) return false;
  let n3 = Object.keys(e3), r2 = Object.keys(t);
  return n3.length === r2.length ? r2.every((n4) => {
    if (!Object.prototype.hasOwnProperty.call(e3, n4)) return false;
    let r3 = e3, i3 = t, a2 = r3[n4], o2 = i3[n4];
    return typeof a2 == "object" && a2 && typeof o2 == "object" && o2 ? j(a2, o2) : a2 === o2;
  }) : false;
}
function M(e3, t, n3) {
  let r2 = t.map((e4, t2) => {
    let n4 = e4.matcher ? JSON.stringify(e4.matcher, void 0, 2) : "any input", r3 = e4.strict ? " (strict mode)" : "";
    return `  Mock #${t2 + 1}: ${n4}${r3}`;
  }).join("\n"), i3 = JSON.stringify(n3, void 0, 2);
...
function N(e3, t) {
  let n3 = JSON.stringify(t, void 0, 2);
...
function F(e3) {
  return async function(t) {
    let n3 = () => this, r2 = k(e3.debugLogger), i3 = t.constructor.name;
    ...
    return r2 && e3.debugLogger.logDirect(`Using mock at index ${o2} for ${i3}`), s2.once && (a2.splice(o2, 1), r2 && e3.debugLogger.logDirect(`Removed one-time mock for ${i3}`)), s2.handler(t.input, n3());
  };
}
var I = (e3, t, n3) => ({
  reset() {
    k(e3.debugLogger) && e3.debugLogger.logDirect(n3.reset), t.mockClear();
  },
  restore() {
    k(e3.debugLogger) && e3.debugLogger.logDirect(n3.restore), t.mockRestore(), e3.map = /* @__PURE__ */ new WeakMap();
  },
  calls() {
...
function L(e3, t, n3, r2 = {}) {
  let i3 = (i4, a3, o2) => {
    ...
    if (a3) {
      ...
      i5 === -1 ? c2.push(s2) : c2.splice(i5, 0, s2), e3.map.set(t, c2), l2 && e3.debugLogger.logDirect(`Configured ${o2}Once for ${t.name}`, n3 ? {
        matcher: n3,
        strict: !!r2.strict
      } : void 0);
    } else {
      let i5 = c2.filter((e4) => e4.once || JSON.stringify(e4.matcher) !== JSON.stringify(n3));
      i5.push(s2), e3.map.set(t, i5), l2 && e3.debugLogger.logDirect(`Configured ${o2} for ${t.name}`, n3 ? {
        matcher: n3,
        strict: !!r2.strict
      } : void 0);
    }
    ...
    resolvesWithDelay(e4, t2) {
      ...
      return i3(() => new Promise(n4), false, "resolvesWithDelay"), a2;
    },
    rejectsWithDelay(e4, t2) {
      let n4 = typeof e4 == "string" ? Error(e4) : e4, r3 = (e5, r4) => {
        setTimeout(() => r4(n4), t2);
      };
    ...
    resolvesPaginated(n4, r3 = {}) {
      let o2 = S(n4, r3), s2 = 0;
      return e3.debugLogger.log(`Configured resolvesPaginated for ${t.name}`, {
        pageSize: r3.pageSize,
        itemsCount: n4.length
      }), i3((e4) => {
        let t2 = r3.tokenKey || "NextToken", n5 = e4[r3.inputTokenKey || t2];
        if (n5 != null) {
          ...
          for (let r4 of o2) {
            ...
            if (i5 && i5.length > 0) {
              let e6 = i5.at(-1);
              if (JSON.stringify(e6) === JSON.stringify(n5)) {
                s2 = t3 + 1;
                break;
              }
            }
    ...
    resolvesFromFile(n4) {
      return e3.debugLogger.log(`Configured resolvesFromFile for ${t.name}`, { filePath: n4 }), i3(() => {
        let e4 = x(n4);
...
var mockEcs = (tasks) => {
  ...
  const list = (0, import_utils4.mockObjectValues)(tasks);
  Object.assign(globalList, list);
  if (alreadyMocked) {
    return list;
  }
  const client = R(import_client_ecs3.ECSClient);
  client.on(import_client_ecs3.RunTaskCommand).callsFake(async (input) => {
    ...
    await (0, import_utils4.nextTick)(callback, payload);
    return {
      tasks: [
        {
