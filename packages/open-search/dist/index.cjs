...
let _awsless_open_search_server = require("@awsless/open-search-server");
...
const mockOpenSearch = ({ engine, version, debug } = {}) => {
	beforeAll && beforeAll(async () => {
		const server = new _awsless_open_search_server.OpenSearchServer({
			engine,
			version,
			debug
		});
...
Object.defineProperty(exports, "VERSION_3_5_0_MIN", {
	enumerable: true,
	get: function() {
		return _awsless_open_search_server.VERSION_3_5_0_MIN;
	}
});
exports.array = array;
...
Object.defineProperty(exports, "download", {
	enumerable: true,
	get: function() {
		return _awsless_open_search_server.download;
	}
});
...
Object.defineProperty(exports, "launch", {
	enumerable: true,
	get: function() {
		return _awsless_open_search_server.launch;
	}
});
