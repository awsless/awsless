...
export declare function task<E, R>(handle: (event: E, context: HandlerContext) => R): SchemalessEntry<E, R>;
export declare function task<S extends GenericSchema, H extends Handler<S>>(schema: S, handle: H): LambdaFunction<H, S>;
export declare const cron: <E, R>(handle: (event: E, context: HandlerContext) => R) => SchemalessEntry<E, R>;
export {};
