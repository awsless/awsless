			...
			ResponseHeadersPolicyConfig: {
				...
				SecurityHeadersConfig: {
					...
					FrameOptions: {
						...
						FrameOption: (
							this.props.frameOptions?.frameOption ?? 'same-origin'
						) === 'same-origin' ? 'SAMEORIGIN' : 'DENY',
					},
					ReferrerPolicy: {
					...
					StrictTransportSecurity: {
						...
						AccessControlMaxAgeSec: this.props.strictTransportSecurity?.maxAge?.toSeconds() ?? 31536000,
