...
declare namespace prompts_d_exports {
  export { confirm$1 as confirm, float, integer, multiSelect, password$1 as password, select$1 as select, text$1 as text };
}
declare const text$1: (opts: TextOptions) => Promise<string>;
declare const password$1: (opts: PasswordOptions) => Promise<string>;
type NumberOptions = {
  message: string;
  placeholder?: string;
  defaultValue?: number;
...
declare const confirm$1: (opts: ConfirmOptions) => Promise<boolean>;
declare const select$1: <Value>(opts: SelectOptions<Value>) => Promise<Exclude<Value, symbol>>;
declare const multiSelect: <Value>(opts: MultiSelectOptions<Value>) => Promise<Value[]>;
declare namespace logs_d_exports {
  export { error, info, intro$1 as intro, list, message, note$1 as note, outro$1 as outro, step, success, table, task, warning };
}
declare const intro$1: (title?: string) => void;
declare const outro$1: (title?: string) => void;
declare const note$1: (title: string, message: string) => void;
