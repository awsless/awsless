...
var WorkSpace = class extends import_events.default {
  ...
  async deployStack(stack2) {
    ...
    return this.lockedOperation(app2.urn, async () => {
      ...
      stackState.exports = this.unwrapDocument(stack2.urn, stack2.exports);
...
var CertificateProvider = class {
  ...
  clients = {};
  own(id2) {
    return id2 === "aws-acm-certificate";
  }
  wait(delay) {
    return new Promise((r) => setTimeout(r, delay));
  }
...
var CertificateValidationProvider = class {
  ...
  clients = {};
  own(id2) {
    return id2 === "aws-acm-certificate-validation";
  }
  client(region2 = this.props.region) {
    if (!this.clients[region2]) {
...
var CertificateValidation = class extends Resource {
  constructor(id2, props) {
    super("AWS::CertificateManager::CertificateValidation", id2, props);
    this.props = props;
...
var Certificate = class extends Resource {
  constructor(id2, props) {
    super("AWS::CertificateManager::Certificate", id2, props);
    this.props = props;
...
var DataSourceProvider = class {
  ...
  own(id2) {
    return id2 === "aws-appsync-data-source";
  }
  async get({ document }) {
  ...
  async update({ id: id2, oldDocument, newDocument }) {
...
var DataSource = class extends Resource {
  constructor(id2, props) {
    super("AWS::AppSync::DataSource", id2, props);
    this.props = props;
  }
...
var DomainNameApiAssociation = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::AppSync::DomainNameApiAssociation", id2, props);
    this.props = props;
  }
  toState() {
    return {
...
var DomainName = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::AppSync::DomainName", id2, props);
    this.props = props;
  }
...
var FunctionConfiguration = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::AppSync::FunctionConfiguration", id2, props);
    this.props = props;
  }
  get id() {
...
var GraphQLApiProvider = class {
  ...
  own(id2) {
    return id2 === "aws-appsync-graphql-api";
  }
  async get({ id: id2 }) {
    const result = await this.client.send(
  ...
  async update({ id: id2, newDocument }) {
    await this.client.send(
...
var GraphQLApi = class extends Resource {
  ...
  constructor(id2, props) {
    super("AWS::AppSync::GraphQLApi", id2, props);
    this.props = props;
  }
  ...
  // }
  assignDomainName(id2, props) {
    const domain2 = new DomainName(id2, props);
    this.add(domain2);
    return domain2;
  }
...
var GraphQLSchemaProvider = class {
  ...
  own(id2) {
    return id2 === "aws-appsync-graphql-schema";
  }
  async get({ id: id2 }) {
    while (true) {
      const result = await this.client.send(
...
var GraphQLSchema = class extends Resource {
  constructor(id2, props) {
    super("AWS::AppSync::GraphQLSchema", id2, props);
    this.props = props;
  }
...
var Resolver = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::AppSync::Resolver", id2, props);
    this.props = props;
  }
  get arn() {
...
var SourceApiAssociation = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::AppSync::SourceApiAssociation", id2, props);
    this.props = props;
  }
  toState() {
    return {
...
var CloudControlApiProvider = class {
  ...
  client;
  own(id2) {
    return id2 === "aws-cloud-control-api";
  }
  ...
  async update({ type, id: id2, oldDocument, newDocument, remoteDocument }) {
    const result = await this.client.send(
...
var Distribution = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::CloudFront::Distribution", id2, props);
    this.props = props;
  }
  // get arn() {
...
var CachePolicy = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::CloudFront::CachePolicy", id2, props);
    this.props = props;
  }
  get id() {
    return this.output((v) => v.Id);
...
var OriginAccessControl = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::CloudFront::OriginAccessControl", id2, props);
    this.props = props;
  }
  get id() {
    return this.output((v) => v.Id);
...
var OriginRequestPolicy = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::CloudFront::OriginRequestPolicy", id2, props);
    this.props = props;
  }
  get id() {
    return this.output((v) => v.Id);
...
var ResponseHeadersPolicy = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::CloudFront::ResponseHeadersPolicy", id2, props);
    this.props = props;
  }
  get id() {
    return this.output((v) => v.Id);
...
var LogGroup = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::Logs::LogGroup", id2, props);
    this.props = props;
  }
  get arn() {
    return this.output((v) => v.Arn);
...
var UserPoolClient = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::Cognito::UserPoolClient", id2, props);
    this.props = props;
  }
  get id() {
...
var UserPoolDomain = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::Cognito::UserPoolDomain", id2, props);
    this.props = props;
  }
  // get domain() {
  // 	return this.ref()
...
var UserPool = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::Cognito::UserPool", id2, props);
    this.props = props;
  }
  get id() {
    return this.output((v) => v.UserPoolId);
  ...
  // }
  addClient(id2, props) {
    const client = new UserPoolClient(id2, {
      ...props,
      userPoolId: this.id
    });
    this.add(client);
...
var TableItemProvider = class {
  ...
  own(id2) {
    return id2 === "aws-dynamodb-table-item";
  }
  marshall(item) {
  ...
  async update({ id: id2, oldDocument, newDocument, assets }) {
  ...
  async delete({ id: id2 }) {
    const [table2, oldKey] = JSON.parse(id2);
    await this.client.send(
      new import_client_dynamodb2.DeleteItemCommand({
        TableName: table2,
        Key: this.marshall(oldKey)
...
var TableItem = class extends Resource {
  constructor(id2, props) {
    super("AWS::DynamoDB::Table::Item", id2, props);
    this.props = props;
  }
...
var Table = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::DynamoDB::Table", id2, props);
    this.props = props;
  ...
  addItem(id2, item) {
    const tableItem = new TableItem(id2, {
      table: this,
      item
    });
    this.add(tableItem);
...
var VPCGatewayAttachment = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::EC2::VPCGatewayAttachment", id2, props);
    this.props = props;
  }
  get vpcId() {
    return this.output((v) => v.VpcId);
...
var SubnetRouteTableAssociation = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::EC2::SubnetRouteTableAssociation", id2, props);
    this.props = props;
  }
  get id() {
    return this.output((v) => v.Id);
...
var Subnet = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::EC2::Subnet", id2, props);
    this.props = props;
  }
  get id() {
...
var SecurityGroup = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::EC2::SecurityGroup", id2, props);
    this.props = props;
  }
  ingress = [];
  egress = [];
...
var RouteTable = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::EC2::RouteTable", id2, props);
    this.props = props;
  }
  get id() {
    return this.output((v) => v.RouteTableId);
...
var InternetGateway = class extends CloudControlApiResource {
  constructor(id2, props = {}) {
    super("AWS::EC2::InternetGateway", id2, props);
    this.props = props;
  }
  get id() {
    return this.output((v) => v.InternetGatewayId);
...
var Rule = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::Events::Rule", id2, props);
    this.props = props;
  }
  get id() {
    return this.output((v) => v.Id);
...
var RolePolicy = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::IAM::RolePolicy", id2, props);
    this.props = props;
  }
  statements = [];
  get id() {
...
var Role = class extends CloudControlApiResource {
  ...
  addPolicy(id2, props) {
    const policy = new RolePolicy(id2, {
      role: this.name,
      ...props
    });
    this.add(policy);
...
var TopicRule = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::IoT::TopicRule", id2, props);
    this.props = props;
  }
  get arn() {
    return this.output((v) => v.Arn);
...
var Url = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::Lambda::Url", id2, props);
    this.props = props;
  }
  get url() {
...
var Permission = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::Lambda::Permission", id2, props);
    this.props = props;
  }
  toState() {
    return {
...
var Function = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::Lambda::Function", id2, props);
    this.props = props;
  }
...
var EventInvokeConfig = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::Lambda::EventInvokeConfig", id2, props);
    this.props = props;
  }
  setOnFailure(arn) {
...
var EventSourceMapping = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::Lambda::EventSourceMapping", id2, props);
    this.props = props;
  }
  setOnFailure(arn) {
    this.props.onFailure = arn;
...
var Cluster = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::MemoryDB::Cluster", id2, props);
    this.props = props;
  }
  // get status() {
...
var SubnetGroup = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::MemoryDB::SubnetGroup", id2, props);
    this.props = props;
  }
  get arn() {
    return this.output((v) => v.ARN);
...
var Collection = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::OpenSearchServerless::Collection", id2, props);
    this.props = props;
  }
  get id() {
    return this.output((v) => v.Id);
...
var RecordSet = class extends Resource {
  constructor(id2, props) {
    super("AWS::Route53::RecordSet", id2, props);
    this.props = props;
  }
...
var RecordSetProvider = class {
  ...
  async create({ document }) {
    const id2 = (0, import_crypto2.randomUUID)();
    await this.client.send(
      new import_client_route_53.ChangeResourceRecordSetsCommand({
        ...
        ChangeBatch: {
          Changes: [
            {
              Action: "CREATE",
              ResourceRecordSet: this.formatRecordSet(id2, document)
            }
          ]
        }
      })
      ...
      new import_client_route_53.ChangeResourceRecordSetsCommand({
        ...
        ChangeBatch: {
          Changes: [
            {
              Action: "UPSERT",
              ResourceRecordSet: this.formatRecordSet(id2, newDocument)
            }
          ]
        }
      })
...
var HostedZone = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::Route53::HostedZone", id2, props);
    this.props = props;
  }
  get id() {
    return this.output((v) => v.Id);
...
var BucketObject = class extends Resource {
  constructor(id2, props) {
    super("AWS::S3::Bucket::Object", id2, props);
    this.props = props;
  }
...
var Bucket = class extends Resource {
  ...
  addObject(id2, props) {
    const object = new BucketObject(id2, {
      ...props,
      bucket: this.name
    });
    this.add(object);
...
var BucketObjectProvider = class {
  ...
  own(id2) {
    return id2 === "aws-s3-bucket-object";
  }
  async get({ document }) {
    const result = await this.client.send(
...
var EmailIdentity = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::SES::EmailIdentity", id2, props);
    this.props = props;
  }
  getDnsToken(index) {
    return this.output((v) => ({
...
var ConfigurationSet = class extends CloudControlApiResource {
  constructor(id2, props) {
    super("AWS::SES::ConfigurationSet", id2, props);
    this.props = props;
  }
  get name() {
    return this.output((v) => v.Name);
...
var SubscriptionProvider = class {
  ...
  own(id2) {
    return id2 === "aws-sns-subscription";
  }
  async get({ id: id2 }) {
    const result = await this.client.send(
...
var Subscription = class extends Resource {
  constructor(id2, props) {
    super("AWS::SNS::Subscription", id2, props);
    this.props = props;
  }
...
app.add(stack);
var table = new aws_exports.dynamodb.Table("test", {
  name: "TEST",
  hash: "key",
  stream: "keys-only"
});
...
var configurationSet = new aws_exports.ses.ConfigurationSet("default", {
  name: "test",
  engagementMetrics: true,
  reputationMetrics: true
});
stack.add(configurationSet);
var hostedZone = new aws_exports.route53.HostedZone("zone", { name: domain });
stack.add(hostedZone);
var usEastCertificate = new aws_exports.acm.Certificate("us-east-cert", {
  domainName: domain,
...
var emailIdentity = new aws_exports.ses.EmailIdentity("email-identity", {
