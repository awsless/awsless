...
var import_duration20 = require("@awsless/duration");
...
var TerraformRegistryProvider = class _TerraformRegistryProvider {
  ...
  get versions() {
    return this.meta.map(
      ...
      return (0, import_semver.compare)(a.version, b.version);
    });
  }
  get latestVersion() {
...
var workspace = new WorkSpace({
  cloudProviders: aws_exports.createCloudProviders({
    ...
    timeout: (0, import_duration20.minutes)(15)
  }),
