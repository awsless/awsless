...
// ../../node_modules/.pnpm/@arcanyx+cidr-slicer@0.3.0/node_modules/@arcanyx/cidr-slicer/dist/ipv4-address.js
var require_ipv4_address = __commonJS({
  "../../node_modules/.pnpm/@arcanyx+cidr-slicer@0.3.0/node_modules/@arcanyx/cidr-slicer/dist/ipv4-address.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ipv4AddressFromInt = exports.ipv4AddressFromString = void 0;
    var MIN_INT32 = 1 << 31;
    var MAX_UINT32 = 4294967295;
    function ipv4AddressFromString(addrStr) {
      if (addrStr.length == 0) {
    ...
    exports.ipv4AddressFromString = ipv4AddressFromString;
    function ipv4AddressFromInt(uintValue) {
    ...
    exports.ipv4AddressFromInt = ipv4AddressFromInt;
    function ipv4ToCanonicalString(uintVal) {
      checkBounds(uintVal);
      const groups = Array(4);
      const octetMask = 255;
      for (let i = 3; i >= 0; i--) {
...
// ../../node_modules/.pnpm/@arcanyx+cidr-slicer@0.3.0/node_modules/@arcanyx/cidr-slicer/dist/cidr-block.js
var require_cidr_block = __commonJS({
  "../../node_modules/.pnpm/@arcanyx+cidr-slicer@0.3.0/node_modules/@arcanyx/cidr-slicer/dist/cidr-block.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.createCidrBlock = exports.cidrBlockFromString = void 0;
    function cidrBlockFromString(block, maxPrefixLength, ipAddressFromString, slice) {
      if (block.length === 0) {
        throw new Error("Cannot parse empty block");
      }
      const [addrStr, prefixLengthStr, tooManySlashes] = block.split("/", 3);
      if (tooManySlashes !== void 0) {
        throw new Error(`Cannot parse malformed ${block}, only expected one "/"`);
      }
      if (prefixLengthStr === void 0 || prefixLengthStr.length === 0) {
        const examplePrefixLength = Math.floor(maxPrefixLength / 2);
        throw new Error(`Cannot parse malformed ${block}, prefix length (e.g., /${examplePrefixLength}) was missing.`);
      }
    ...
    exports.cidrBlockFromString = cidrBlockFromString;
    function createCidrBlock(address, prefixLength, maxPrefixLength, slice) {
      if (!Number.isInteger(prefixLength) || prefixLength < 0 || prefixLength > maxPrefixLength) {
        throw new Error(`Invalid CIDR block ${address.toString()}/${prefixLength}, prefix length L must be 0 <= L <= ${maxPrefixLength}.`);
      }
      address = address.mask(prefixLength);
      return {
        address,
        prefixLength,
        slice(slicePrefixLength) {
    ...
    exports.createCidrBlock = createCidrBlock;
  }
});

// ../../node_modules/.pnpm/@arcanyx+cidr-slicer@0.3.0/node_modules/@arcanyx/cidr-slicer/dist/ipv4-cidr-block.js
var require_ipv4_cidr_block = __commonJS({
  "../../node_modules/.pnpm/@arcanyx+cidr-slicer@0.3.0/node_modules/@arcanyx/cidr-slicer/dist/ipv4-cidr-block.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ipv4CidrBlockFromString = void 0;
    var cidr_block_1 = require_cidr_block();
    var ipv4_address_1 = require_ipv4_address();
    var maxPrefixLength = 32;
    var maxBitsLength = 32;
    function ipv4CidrBlockFromString(block) {
      return (0, cidr_block_1.cidrBlockFromString)(block, maxPrefixLength, ipv4_address_1.ipv4AddressFromString, createSlices);
    }
    exports.ipv4CidrBlockFromString = ipv4CidrBlockFromString;
    function createSlices(block, slicePrefixLength) {
      if (!Number.isInteger(slicePrefixLength) || slicePrefixLength < block.prefixLength) {
        throw new Error(`slicePrefixLength (${slicePrefixLength}) cannot be less than block.prefixLength (${block.prefixLength})`);
      }
      if (slicePrefixLength > maxPrefixLength) {
        throw new Error(`slicePrefixLength (${slicePrefixLength}) exceeds max prefix length (${maxPrefixLength})`);
      }
      ...
      return {
        ...
        get(i) {
          ...
          return (0, cidr_block_1.createCidrBlock)((0, ipv4_address_1.ipv4AddressFromInt)(sliceAddrVal), slicePrefixLength, maxPrefixLength, createSlices);
        }
      };
    }
  }
...
// ../../node_modules/.pnpm/@arcanyx+cidr-slicer@0.3.0/node_modules/@arcanyx/cidr-slicer/dist/ipv6-address.js
var require_ipv6_address = __commonJS({
  "../../node_modules/.pnpm/@arcanyx+cidr-slicer@0.3.0/node_modules/@arcanyx/cidr-slicer/dist/ipv6-address.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ipv6AddressFromBigInt = exports.ipv6AddressFromString = exports.ipv6BitLength = void 0;
    exports.ipv6BitLength = 128;
    function ipv6AddressFromString(addrStr) {
      if (addrStr.length == 0) {
        throw new Error("Cannot parse empty address");
      }
      const [preElision, postElision, tooMuchElision] = addrStr.split("::", 3);
      if (tooMuchElision !== void 0) {
    ...
    exports.ipv6AddressFromString = ipv6AddressFromString;
    function ipv6AddressFromBigInt(bigIntValue) {
      return {
        bigIntValue,
        toString() {
        ...
        mask(prefixLength) {
          if (!Number.isInteger(prefixLength) || prefixLength < 0 || prefixLength > exports.ipv6BitLength) {
            throw new Error(`Invalid prefix length: ${prefixLength}`);
          }
          const bitsToWipeOut = BigInt(exports.ipv6BitLength - prefixLength);
    ...
    exports.ipv6AddressFromBigInt = ipv6AddressFromBigInt;
    function ipV6ToCanonicalString(addr) {
      ...
      return groupStrs.slice(0, longestZeroStart).join(":").concat("::").concat(groupStrs.slice(longestZeroStart + longestZeroLength).join(":"));
    }
    function splitIntoGroups(partialAddrStr) {
      if (partialAddrStr === void 0 || partialAddrStr.length === 0) {
        return [];
      }
...
// ../../node_modules/.pnpm/@arcanyx+cidr-slicer@0.3.0/node_modules/@arcanyx/cidr-slicer/dist/ipv6-cidr-block.js
var require_ipv6_cidr_block = __commonJS({
  "../../node_modules/.pnpm/@arcanyx+cidr-slicer@0.3.0/node_modules/@arcanyx/cidr-slicer/dist/ipv6-cidr-block.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ipv6CidrBlockFromString = void 0;
    var cidr_block_1 = require_cidr_block();
    var ipv6_address_1 = require_ipv6_address();
    var maxPrefixLength = 64;
    var maxBitsLength = 128;
    function ipv6CidrBlockFromString2(block) {
      return (0, cidr_block_1.cidrBlockFromString)(block, maxPrefixLength, ipv6_address_1.ipv6AddressFromString, createSlices);
    }
    exports.ipv6CidrBlockFromString = ipv6CidrBlockFromString2;
    function createSlices(block, slicePrefixLength) {
      ...
      return {
        ...
        get(i) {
          ...
          return (0, cidr_block_1.createCidrBlock)((0, ipv6_address_1.ipv6AddressFromBigInt)(sliceAddrVal), slicePrefixLength, maxPrefixLength, createSlices);
        }
      };
    }
  }
...
// ../../node_modules/.pnpm/@arcanyx+cidr-slicer@0.3.0/node_modules/@arcanyx/cidr-slicer/dist/index.js
var require_dist = __commonJS({
  "../../node_modules/.pnpm/@arcanyx+cidr-slicer@0.3.0/node_modules/@arcanyx/cidr-slicer/dist/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ipv6CidrBlockFromString = exports.ipv6AddressFromString = exports.ipv6AddressFromBigInt = exports.ipv4CidrBlockFromString = exports.ipv4AddressFromString = exports.ipv4AddressFromInt = void 0;
    var ipv4_address_1 = require_ipv4_address();
    Object.defineProperty(exports, "ipv4AddressFromInt", { enumerable: true, get: function() {
      return ipv4_address_1.ipv4AddressFromInt;
    } });
    Object.defineProperty(exports, "ipv4AddressFromString", { enumerable: true, get: function() {
      return ipv4_address_1.ipv4AddressFromString;
    } });
    var ipv4_cidr_block_1 = require_ipv4_cidr_block();
    Object.defineProperty(exports, "ipv4CidrBlockFromString", { enumerable: true, get: function() {
      return ipv4_cidr_block_1.ipv4CidrBlockFromString;
    } });
    var ipv6_address_1 = require_ipv6_address();
    Object.defineProperty(exports, "ipv6AddressFromBigInt", { enumerable: true, get: function() {
      return ipv6_address_1.ipv6AddressFromBigInt;
    } });
    Object.defineProperty(exports, "ipv6AddressFromString", { enumerable: true, get: function() {
      return ipv6_address_1.ipv6AddressFromString;
    } });
    var ipv6_cidr_block_1 = require_ipv6_cidr_block();
    Object.defineProperty(exports, "ipv6CidrBlockFromString", { enumerable: true, get: function() {
      return ipv6_cidr_block_1.ipv6CidrBlockFromString;
    } });
  }
});
      ...
      document: {
        DistributionConfig: {
          ...
          CustomErrorResponses: unwrap(this.props.customErrorResponses, []).map((v) => unwrap(v)).map((item) => ({
            ...
            ...this.attr(
              "ErrorCachingMinTTL",
              item.cacheMinTTL && toSeconds5(unwrap(item.cacheMinTTL))
            ),
  ...
  toState() {
    ...
    return {
      document: {
        ...
        ...this.attr("DestinationIpv6CidrBlock", this.props.destinationIpv6, (v) => v.ip)
        // ...(destination.type === 'v4'
        // 	? { DestinationCidrBlock: destination.ip }
  ...
  toState() {
    return {
      document: {
        ...
        ...this.attr("AssignIpv6AddressOnCreation", this.props.assignIpv6AddressOnCreation),
        Tags: [
          {
            Key: "Name",
            Value: this.props.name
...
import { days as days3, toSeconds as toSeconds7 } from "@awsless/duration";
  ...
  toJSON() {
    ...
    return {
      ...
      AuthenticateCognitoConfig: {
        ...
        SessionTimeout: toSeconds7(unwrap(session.timeout, days3(7))),
  ...
  toState() {
    ...
    return {
      ...
      document: {
        ...
        Timeout: toSeconds10(unwrap(this.props.timeout, seconds(10))),
...
var Url = class extends CloudControlApiResource {
  ...
  cors() {
    ...
    return {
      ...
      ...this.attr("AllowOrigins", allow.origins),
      ...this.attr("ExposeHeaders", expose.headers),
      ...this.attr("MaxAge", cors.maxAge, toSeconds11)
    };
  }
  toState() {
    return {
...
var import_cidr_slicer = __toESM(require_dist(), 1);
import { fromIni } from "@aws-sdk/credential-providers";
import { minutes as minutes4 } from "@awsless/duration";
var createWorkspace = (profile, region2 = "eu-west-1", timeout = 15) => {
...
var createVPC = (stack2, region2, ns = "formation") => {
  const group = new Node(stack2, "vpc", ns);
  const vpc = new aws_exports.ec2.Vpc(group, "vpc", {
    name: `vpc-${ns}`,
    cidrBlock: aws_exports.ec2.Peer.ipv4("10.0.0.0/16")
  });
  const cidrBlock = new aws_exports.ec2.VPCCidrBlock(group, "vpc", {
    vpcId: vpc.id,
    amazonProvidedIpv6CidrBlock: true
  });
  const privateRouteTable = new aws_exports.ec2.RouteTable(group, "private", {
    vpcId: vpc.id,
    name: "private"
  });
  const publicRouteTable = new aws_exports.ec2.RouteTable(group, "public", {
    vpcId: vpc.id,
    name: "public"
  });
  const gateway = new aws_exports.ec2.InternetGateway(group, "gateway");
  new aws_exports.ec2.VPCGatewayAttachment(group, "attachment", {
    vpcId: vpc.id,
    internetGatewayId: gateway.id
  });
  new aws_exports.ec2.Route(group, "route", {
    gatewayId: gateway.id,
    routeTableId: publicRouteTable.id,
    destination: aws_exports.ec2.Peer.anyIpv4(),
    destinationIpv6: aws_exports.ec2.Peer.anyIpv6()
  });
  const zones = ["a", "b"];
  ...
  const ip6Block = (0, import_cidr_slicer.ipv6CidrBlockFromString)("2a05:d018:17a5:4200::/56");
  ...
  for (const table of tables) {
    for (const i in zones) {
      ...
      const subnet = new aws_exports.ec2.Subnet(group, id, {
        name: `subnet-${table.identifier}-${index}`,
        vpcId: vpc.id,
        cidrBlock: aws_exports.ec2.Peer.ipv4(`10.0.${block++}.0/24`),
        ipv6CidrBlock: aws_exports.ec2.Peer.ipv6(slices.get(BigInt(block)).toString()),
        availabilityZone: region2 + zones[i],
        assignIpv6AddressOnCreation: true
        // ipv6Native: true,
      });
      subnet.dependsOn(cidrBlock);
      new aws_exports.ec2.SubnetRouteTableAssociation(group, id, {
...
// examples/resources/vpc.ts
var region = "eu-west-1";
var workspace = createWorkspace("jacksclub");
var app = new App("vpc");
var stack = new Stack(app, "vpc");
