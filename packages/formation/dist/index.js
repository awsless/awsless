...
var WorkSpace = class extends EventEmitter {
  ...
  deployStackResources(appUrn, appState, stackState, resources) {
    return __async(this, null, function* () {
      ...
      const results = yield Promise.allSettled(Object.values(run(deployGraph)));
  ...
  deleteStackResources(appUrn, appState, stackState, resources) {
    return __async(this, null, function* () {
      ...
      const deleteResults = yield Promise.allSettled(Object.values(run(deleteGraph)));
      yield this.props.stateProvider.update(appUrn, appState);
...
var CertificateProvider = class {
  ...
  client(region = this.props.region) {
    if (!this.clients[region]) {
      this.clients[region] = new ACMClient(__spreadProps(__spreadValues({}, this.props), {
        region
      }));
    }
  ...
  create(_0) {
    return __async(this, arguments, function* ({ urn, document, extra }) {
      ...
      const result = yield this.client(extra.region).send(
        new RequestCertificateCommand(__spreadValues({
...
var CertificateValidationProvider = class {
  ...
  client(region = this.props.region) {
    if (!this.clients[region]) {
      this.clients[region] = new ACMClient2(__spreadProps(__spreadValues({}, this.props), {
        region
      }));
    }
    return this.clients[region];
...
var DataSourceProvider = class {
  ...
  create(_0) {
    return __async(this, arguments, function* ({ document }) {
      yield this.client.send(new CreateDataSourceCommand(document));
  ...
  update(_0) {
    return __async(this, arguments, function* ({ id, oldDocument, newDocument }) {
      ...
      yield this.client.send(new UpdateDataSourceCommand(newDocument));
      return id;
    });
  }
  delete(_0) {
...
var GraphQLApiProvider = class {
  ...
  create(_0) {
    return __async(this, arguments, function* ({ document }) {
      var _a;
      const result = yield this.client.send(new CreateGraphqlApiCommand(document));
  ...
  update(_0) {
    return __async(this, arguments, function* ({ id, newDocument }) {
      yield this.client.send(
        new UpdateGraphqlApiCommand(__spreadValues({
          apiId: id
        }, newDocument))
      );
      return id;
...
var GraphQLApi = class extends Resource {
  ...
  formatAuth(props) {
    ...
    return {
      ...
      }, this.attr("authorizerResultTtlInSeconds", prop.resultTtl && toSeconds(unwrap(prop.resultTtl)))), this.attr("identityValidationExpression", prop.tokenRegex))
    };
  }
  toState() {
...
var CloudControlApiProvider = class {
  ...
  progressStatus(event) {
    return __async(this, null, function* () {
      ...
      const timeout = Number(toMilliSeconds((_a = this.props.timeout) != null ? _a : minutes(1)));
      while (true) {
      ...
      document: {
        DistributionConfig: {
          ...
          CustomErrorResponses: unwrap(this.props.customErrorResponses, []).map((v) => unwrap(v)).map((item) => __spreadValues(__spreadValues(__spreadValues({
            ...
            "ErrorCachingMinTTL",
            item.cacheMinTTL && toSeconds2(unwrap(item.cacheMinTTL))
  ...
  toState() {
    return {
      document: {
        CachePolicyConfig: {
          Name: this.props.name,
          MinTTL: toSeconds3(unwrap(this.props.minTtl)),
          MaxTTL: toSeconds3(unwrap(this.props.maxTtl)),
          DefaultTTL: toSeconds3(unwrap(this.props.defaultTtl)),
    ...
    return {
      document: {
        OriginRequestPolicyConfig: {
          Name: this.props.name,
          CookiesConfig: __spreadValues({
            CookieBehavior: camelCase(unwrap(cookie == null ? void 0 : cookie.behavior, "all"))
          }, this.attr("Cookies", cookie == null ? void 0 : cookie.values)),
          HeadersConfig: __spreadValues({
            HeaderBehavior: camelCase(unwrap(header == null ? void 0 : header.behavior, "all-viewer"))
          }, this.attr("Headers", header == null ? void 0 : header.values)),
          QueryStringsConfig: __spreadValues({
            QueryStringBehavior: camelCase(unwrap(query == null ? void 0 : query.behavior, "all"))
...
var UserPoolClient = class extends CloudControlApiResource {
  ...
  toState() {
    ...
    return {
      ...
      )), this.attr("AccessTokenValidity", validity.accessToken && toHours(unwrap(validity.accessToken)))), this.attr("IdTokenValidity", validity.idToken && toHours(unwrap(validity.idToken)))), this.attr(
        ...
        Policies: {
          PasswordPolicy: {
            ...
            TemporaryPasswordValidityDays: toDays3(
              unwrap(password == null ? void 0 : password.temporaryPasswordValidity, days2(7))
            )
          }
        },
...
var UserPoolEmail = class _UserPoolEmail {
  ...
  toJSON() {
    return __spreadValues(__spreadValues(__spreadValues(__spreadValues({}, this.props.type ? { EmailSendingAccount: constantCase(this.props.type) } : {}), this.props.from ? { From: this.props.from } : {}), this.props.replyTo ? { ReplyToEmailAddress: this.props.replyTo } : {}), this.props.sourceArn ? { SourceArn: this.props.sourceArn } : {});
  }
};
...
__export(iam_exports, {
  ...
  formatPolicyDocument: () => formatPolicyDocument2,
  formatStatement: () => formatStatement2,
...
var Url = class extends AwsResource {
  ...
  cors() {
    ...
    return __spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, this.attr("AllowCredentials", allow.credentials)), this.attr("AllowHeaders", allow.headers)), this.attr("AllowMethods", allow.methods)), this.attr("AllowOrigins", allow.origins)), this.attr("ExposeHeaders", expose.headers)), this.attr("MaxAge", cors.maxAge, toSeconds5));
  }
  toState() {
    return {
      document: __spreadProps(__spreadValues({
        AuthType: constantCase3(unwrap(this.props.authType, "none")),
        InvokeMode: constantCase3(unwrap(this.props.invokeMode, "buffered")),
...
var Permission = class extends AwsResource {
  ...
  toState() {
    return {
      ...
      }, this.attr("SourceArn", this.props.sourceArn)), this.attr("FunctionUrlAuthType", this.props.urlAuthType, constantCase4))
    };
  }
};
...
import { seconds, toSeconds as toSeconds6 } from "@awsless/duration";
  ...
  toState() {
    ...
    return {
      ...
      document: __spreadProps(__spreadValues(__spreadValues(__spreadProps(__spreadValues({
        ...
        Timeout: toSeconds6(unwrap(this.props.timeout, seconds(10))),
...
var EventInvokeConfig = class extends CloudControlApiResource {
  ...
  toState() {
    return {
      ...
      }, this.attr("MaximumEventAgeInSeconds", this.props.maxEventAge, toSeconds7)), this.attr("MaximumRetryAttempts", this.props.retryAttempts)), this.props.onFailure || this.props.onSuccess ? {
...
var EventSourceMapping = class extends CloudControlApiResource {
  ...
  toState() {
    return {
      ...
      }, this.attr("BatchSize", this.props.batchSize)), this.attr("MaximumBatchingWindowInSeconds", this.props.maxBatchingWindow, toSeconds8)), this.attr("MaximumRecordAgeInSeconds", this.props.maxRecordAge, toSeconds8)), this.attr("MaximumRetryAttempts", this.props.retryAttempts)), this.attr("ParallelizationFactor", this.props.parallelizationFactor)), this.attr("TumblingWindowInSeconds", this.props.tumblingWindow, toSeconds8)), this.attr("BisectBatchOnFunctionError", this.props.bisectBatchOnError)), this.attr("StartingPosition", this.props.startingPosition, constantCase6)), this.attr("StartingPositionTimestamp", this.props.startingPositionTimestamp)), this.props.maxConcurrency ? {
        ScalingConfig: {
...
import { minutes as minutes2, toSeconds as toSeconds9 } from "@awsless/duration";
var formatRecordSet = (record) => {
  ...
  return __spreadValues(__spreadValues({
    ...
    TTL: toSeconds9(unwrap(record.ttl, minutes2(5))),
        ...
        PolicyDocument: {
          ...
          Statement: unwrap(this.props.statements, []).map((s) => unwrap(s)).map((statement) => {
            ...
            return __spreadValues(__spreadProps(__spreadValues({
              Effect: capitalCase3((_a2 = statement.effect) != null ? _a2 : "allow")
            }, statement.principal ? {
              Principal: {
    ...
    return {
      document: __spreadProps(__spreadValues(__spreadValues({
        ...
        DkimSigningAttributes: {
          NextSigningKeyLength: constantCase7(unwrap(this.props.dkim))
        }
      } : {}), {
        FeedbackAttributes: {
...
import { days as days3, seconds as seconds2, toSeconds as toSeconds10 } from "@awsless/duration";
  ...
  toState() {
    return {
      document: __spreadValues({
        ...
        Tags: [{ Key: "name", Value: this.props.name }],
        DelaySeconds: toSeconds10(unwrap(this.props.deliveryDelay, seconds2(0))),
        MaximumMessageSize: toBytes(unwrap(this.props.maxMessageSize, kibibytes(256))),
        MessageRetentionPeriod: toSeconds10(unwrap(this.props.retentionPeriod, days3(4))),
        ReceiveMessageWaitTimeSeconds: toSeconds10(unwrap(this.props.receiveMessageWaitTime, seconds2(0))),
        VisibilityTimeout: toSeconds10(unwrap(this.props.visibilityTimeout, seconds2(30)))
...
var LocalStateProvider = class {
  ...
  get(urn) {
    return __async(this, null, function* () {
      let json;
      try {
        json = yield readFile2(join(this.stateFile(urn)), "utf8");
      } catch (error) {
        return {};
      }
  ...
  update(urn, state) {
    return __async(this, null, function* () {
      yield this.mkdir();
      yield writeFile(this.stateFile(urn), JSON.stringify(state, void 0, 2));
    });
  }
  delete(urn) {
    return __async(this, null, function* () {
      yield this.mkdir();
      yield rm(this.stateFile(urn));
    });
  }
};
export {
