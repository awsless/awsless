...
// examples/resources/cloudfront.ts
...
var Asset = class {
  ...
  static fromRemote(url2) {
    return new RemoteAsset(url2);
  }
};
...
var app = new App("cloudfront");
var stack = new Stack(app, "cloudfront");
...
var url = new aws_exports.lambda.Url(stack, "url", {
  targetArn: lambda.arn,
  authType: "aws-iam",
  invokeMode: "buffered"
});
var accessControl = new aws_exports.cloudFront.OriginAccessControl(stack, `oac`, {
  name: "formation-test",
  type: "lambda",
  behavior: "always",
  protocol: "sigv4"
});
var cache = new aws_exports.cloudFront.CachePolicy(stack, "cache", {
  name: "formation-test",
  minTtl: seconds3(1),
  maxTtl: days5(365),
  defaultTtl: days5(1)
});
var distribution = new aws_exports.cloudFront.Distribution(stack, "distribution", {
  name: "formation-test",
  compress: true,
  origins: [
    {
