...
export type QueryRequest = {
	...
	transactions?: {
		__args?: {
			limit?: Arg<'Int', Scalars['Int'] | undefined> | (Scalars['Int'] | undefined)
			cursor?: Arg<'String', Scalars['String'] | undefined> | (Scalars['String'] | undefined)
		}
	} & TransactionRequest
...
export type MutationRequest = {
	transact?: {
		__args: {
			amount: Arg<'Float!', Scalars['Float']> | Scalars['Float']
			currency: Arg<'Currency!', Currency> | Currency
		}
	} & TransactionRequest
	[key: `${string}:transact`]: {
		__args: {
	...
	login?: {
		__args: {
			email: Arg<'String!', Scalars['String']> | Scalars['String']
			password: Arg<'String!', Scalars['String']> | Scalars['String']
		}
